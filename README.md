...
4. (Опционально) Ниже приведены настройки по-умолчанию, дли их изменения создайте файл `terraform.tfvars` в директории `terraform/` и укажите в нем необходимые параметры, например `vps_count = 4`
...
Чтобы снова получить IP-адрес юалансировщика, выполните команду:
```bash
